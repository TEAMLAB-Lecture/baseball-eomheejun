...
def is_validated_number(user_input_number):
    ...
    if user_input_number.isdigit() == True and 100<=int(user_input_number)<1000 and len(set(user_input_number))<=2:
        return True
    return False
...
def is_yes(one_more_input):
    ...
    if one_more_input.lower() == 'y' or 'yes':
        return True
    # ==================================
    else:
        return False
...
def is_no(one_more_input):
    ...
    if one_more_input.lower() == 'n' or 'no':
        return True
    # ==================================
    else:
        return False
...
def main():
    print("Play Baseball")
    user_input = 999
    random_number = int(get_not_duplicated_three_digit_number())
