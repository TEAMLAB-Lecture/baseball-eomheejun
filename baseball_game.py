...
def is_validated_number(user_input_number):
    ...
    if user_input_number.isdigit() == True and 100<=int(user_input_number)<1000 and len(set(user_input_number))==3:
        return True
    else:
        return False
...
def is_yes(one_more_input):
    ...
    if one_more_input=="y" or one_more_input == "Y" or one_more_input.lower() == 'yes':
        return True
    # ==================================
    else:
        return False
